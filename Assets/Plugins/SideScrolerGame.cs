...
public class SideScrolerGame : MonoBehaviour
{
       ...
       public struct GameItem
        {
            ...
            public Texture2D FirsIcon;//базова€ иконка
            public Texture2D DestroyIcon;//уничтоженан€ иконка
        }
    ...
    IEnumerator CreateItem(int id)
    {
        ...
        go.transform.position = new Vector3(Random.Range(2,4), Random.Range(2, 4),0);//случайна€ позици€
